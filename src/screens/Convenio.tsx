...
const iconMap: Record<string, IconConfig> = {
  ...
  "energia-solar": { lib: "Ionicons", name: "flash" },
  ...
  hotel: { lib: "FontAwesome5", name: "concierge-bell" },
  ...
  "seguro-e-previdencia": { lib: "MaterialIcons", name: "lock-person" },
  "servicos-automotivos": { lib: "FontAwesome5", name: "car-alt" },
  "servicos-de-seguranca": { lib: "Feather", name: "lock" },
  "servicos-financeiros": { lib: "FontAwesome", name: "line-chart" },
  "servicos-gerais": { lib: "Feather", name: "settings" },
  tecnologia: { lib: "FontAwesome5", name: "project-diagram" },
  turismo: { lib: "FontAwesome5", name: "plane-departure" },
  "vestuario-e-acessorios": { lib: "Feather", name: "shopping-bag" },
  veterinaria: { lib: "MaterialIcons", name: "pets" },
  default: { lib: "FontAwesome", name: "paw" },
};
